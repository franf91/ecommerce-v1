	...
	return (
		<div>
			<div className="added-item-container">
				...
				<div className="added-item-product-info">
					<div className="added-item-product-img">
						<img src={`../../img/${item.category}/${item.img}`}></img>
					</div>
					<div className="added-item-product-name">{item.name}</div>
					<div className="added-item-product-price">${item.price}</div>
				</div>

				<div className="added-item-button-container">
					<div className="added-item-button">
						<Link href="/[category]/[item]" as={`/${category}/${productID}`}>
